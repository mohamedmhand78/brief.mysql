...
<head>
    ...
    <link rel="stylesheet" href="prepared.css">
</head>
<body>
    ...
    if (isset($_POST["submit"])) {
        ...
        try {
            ...
            $stmt1 = $connect->prepare("INSERT INTO testtb1 (First_name,Last_name,Email) VALUES (:firstname1,:lastname1,:email1)");
            $stmt1->bindParam(':firstname1', $firstname1);
            $stmt1->bindParam(':lastname1', $lastname1);
            $stmt1->bindParam(':email1', $email1);
      
            $stmt1->execute();
            $stmt2 = $connect->prepare("INSERT INTO testtb1 (First_name,Last_name,Email) VALUES (:firstname2,:lastname2,:email2)");
            $stmt2->bindParam(':firstname2', $firstname2);
            $stmt2->bindParam(':lastname2', $lastname2);
